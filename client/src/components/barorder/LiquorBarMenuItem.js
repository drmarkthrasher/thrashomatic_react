...
const LiquorBarMenuItem = (props) => {
  ...
  var thisliquor = {
    ...
    isAvailable: props.liquor.isAvailable,
    type: props.liquor.type,
  };
...
export default LiquorBarMenuItem;
